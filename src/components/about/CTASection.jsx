          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-base sm:text-lg text-blue-100 leading-relaxed font-normal max-w-xl">
                Take the next step in your career with practical education, live
                mentorship, and guaranteed career placement support.
              </p>

              {/* Proof pills */}
              <div className="flex flex-wrap gap-3 pt-1">
                {[
                  { emoji: '🎓', text: '15,000+ Alumni' },
                  { emoji: '🏆', text: '98% Placement' },
                  { emoji: '💼', text: '200+ Hiring Partners' },
                ].map((item) => (
                  <span
                    key={item.text}
